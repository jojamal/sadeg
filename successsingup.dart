...
class successinguppage extends StatelessWidget {
successinguppage({super.key});
...
const SizedBox(height: 100,),
        ...
        const Text("{successingup}",style: TextStyle(fontSize: 35,fontWeight:FontWeight.bold,),),
